...
export const metadata: Metadata = {
  title: "Comprehensive Health Insurance - Cashless Hospitalization | KalyaniFinance",
  description: "Secure your family's future with robust health insurance plans. Enjoy cashless hospitalization across 10,000+ network hospitals, critical illness coverage, and tax benefits.",
}

const highlights = [
  { icon: Banknote, label: "Coverage Amount", value: "Up to ₹1 Crore", desc: "Extensive protection for major medical events", accent: "bg-emerald-50 text-emerald-600 border-emerald-100" },
  { icon: HeartPulse, label: "Network Hospitals", value: "10,000+", desc: "Pan-India cashless treatment network", accent: "bg-blue-50 text-blue-600 border-blue-100" },
  { icon: Clock, label: "Claim Settlement", value: "99.4%", desc: "Fast and transparent claim processing", accent: "bg-amber-50 text-amber-600 border-amber-100" },
  { icon: Award, label: "Tax Benefits", value: "Under Sec 80D", desc: "Save up to ₹75,000 on annual premiums", accent: "bg-purple-50 text-purple-600 border-purple-100" },
]
      ...
      <div className="min-h-screen bg-slate-50/50 text-slate-900 pb-24 pt-20">
            ...
            <div className="grid lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-7">
                <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-500/20 border border-blue-400/30 text-blue-200 text-xs font-semibold uppercase tracking-wider mb-6 backdrop-blur-md">
                  <Sparkles className="w-3.5 h-3.5 text-blue-400" /> Comprehensive Medical Shield
                </div>
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight mb-6 leading-tight">
                  Protect Your Family’s Health with Complete <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-300">Health Insurance</span>
                </h1>
                ...
                <div className="flex flex-wrap items-center gap-4">
                  <Button size="lg" className="bg-blue-600 hover:bg-blue-500 text-white font-semibold px-8 h-12 rounded-xl shadow-lg shadow-blue-600/30 transition-all" asChild>
                    <Link href="/contact">Get Health Cover Quote</Link>
                  </Button>
              ...
              <div className="lg:col-span-5 flex justify-center">
                <div className="w-full max-w-md bg-slate-800/80 border border-slate-700/80 rounded-3xl p-6 sm:p-8 backdrop-blur-xl shadow-2xl relative">
                  <div className="flex items-center justify-between mb-6">
                    <span className="text-xs font-bold uppercase tracking-widest text-blue-400">Medical Security</span>
                    <span className="w-2.5 h-2.5 rounded-full bg-emerald-400 animate-ping" />
                  </div>
                  <h3 className="text-2xl font-bold text-white mb-2">10,000+ Network Hospitals</h3>
                  <p className="text-sm text-slate-300 mb-6">Experience worry-free hospitalization with direct cashless settlements pan-India.</p>
                  ...
                  <div className="space-y-3 pt-4 border-t border-slate-700">
                    <div className="flex items-center gap-3 text-sm text-slate-300">
                      ...
                      <span>No Claim Bonus for Claim-Free Years</span>
                    </div>
                    <div className="flex items-center gap-3 text-sm text-slate-300">
                      <div className="w-5 h-5 rounded-full bg-blue-500/20 text-blue-400 flex items-center justify-center text-xs font-bold">✓</div>
                      <span>Pre & Post Hospitalization Expenses Covered</span>
                    </div>
                    <div className="flex items-center gap-3 text-sm text-slate-300">
                      <div className="w-5 h-5 rounded-full bg-blue-500/20 text-blue-400 flex items-center justify-center text-xs font-bold">✓</div>
                      <span>Free Annual Health Check-ups Included</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
          <div className="mb-6">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 mt-1">Tailored Health Insurance Options</h2>
          </div>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
          <div className="bg-white border border-slate-200/80 rounded-3xl p-8 sm:p-10 shadow-sm">
            <div className="mb-8">
              <span className="text-blue-600 font-semibold text-sm tracking-wider uppercase">Purchase Journey</span>
              <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 mt-1">4 Easy Steps to Get Covered</h2>
            </div>
