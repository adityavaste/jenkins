...
export const metadata: Metadata = {
  title: "Loan Against Property - High Value & Low Rates | KalyaniFinance",
  description: "Unlock the hidden value of your residential or commercial property with KalyaniFinance. Get high-value loans up to ₹10 Crores with flexible usage and competitive interest rates.",
}

const highlights = [
  { icon: Banknote, label: "Interest Rate", value: "9.25% p.a.*", desc: "Cost-effective borrowing against assets", accent: "bg-emerald-50 text-emerald-600 border-emerald-100" },
  { icon: Building, label: "Loan Amount", value: "Up to ₹10 Crores", desc: "Maximize your property's market worth", accent: "bg-blue-50 text-blue-600 border-blue-100" },
  { icon: Clock, label: "Sanction Time", value: "72 Hours", desc: "Fast approval for urgent business or personal needs", accent: "bg-amber-50 text-amber-600 border-amber-100" },
  { icon: Award, label: "Loan Tenure", value: "Up to 15 Years", desc: "Extended repayment plans for manageable EMIs", accent: "bg-purple-50 text-purple-600 border-purple-100" },
]
...
const requirements = {
  ...
  documents: [
    "Identity & Address Proof (PAN Card, [Aadhaar Redacted], Passport)",
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-slate-50/50 text-slate-900 pb-24 pt-20">
            ...
            <div className="grid lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-7">
                <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-500/20 border border-blue-400/30 text-blue-200 text-xs font-semibold uppercase tracking-wider mb-6 backdrop-blur-md">
                  <Sparkles className="w-3.5 h-3.5 text-blue-400" /> High-Value Asset Backing
                </div>
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight mb-6 leading-tight">
                  Unlock Your Real Estate's Potential with a <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-300">Loan Against Property</span>
                </h1>
                ...
                <div className="flex flex-wrap items-center gap-4">
                  <Button size="lg" className="bg-blue-600 hover:bg-blue-500 text-white font-semibold px-8 h-12 rounded-xl shadow-lg shadow-blue-600/30 transition-all" asChild>
                    <Link href="/contact">Apply For LAP</Link>
                  </Button>
              ...
              <div className="lg:col-span-5 flex justify-center">
                <div className="w-full max-w-md bg-slate-800/80 border border-slate-700/80 rounded-3xl p-6 sm:p-8 backdrop-blur-xl shadow-2xl relative">
                  <div className="flex items-center justify-between mb-6">
                    <span className="text-xs font-bold uppercase tracking-widest text-blue-400">Asset Monetization</span>
                    <span className="w-2.5 h-2.5 rounded-full bg-emerald-400 animate-ping" />
                  </div>
                  <h3 className="text-2xl font-bold text-white mb-2">Flexible End-Use</h3>
                  <p className="text-sm text-slate-300 mb-6">Fulfill broad personal or commercial liquidity requirements while maintaining property ownership.</p>
                  ...
                  <div className="space-y-3 pt-4 border-t border-slate-700">
                    <div className="flex items-center gap-3 text-sm text-slate-300">
                      ...
                      <span>High LTV up to 75% of Valuation</span>
                    </div>
                    <div className="flex items-center gap-3 text-sm text-slate-300">
                      <div className="w-5 h-5 rounded-full bg-blue-500/20 text-blue-400 flex items-center justify-center text-xs font-bold">✓</div>
                      <span>Extended Repayment Tenure up to 15 Years</span>
                    </div>
                    <div className="flex items-center gap-3 text-sm text-slate-300">
                      <div className="w-5 h-5 rounded-full bg-blue-500/20 text-blue-400 flex items-center justify-center text-xs font-bold">✓</div>
                      <span>Simplified Doorstep Documentation</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
          <div className="mb-6">
            <span className="text-blue-600 font-semibold text-sm tracking-wider uppercase">Borrowing Objectives</span>
            <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 mt-1">Tailored Loan Against Property Uses</h2>
          </div>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
          <div className="bg-white border border-slate-200/80 rounded-3xl p-8 sm:p-10 shadow-sm">
            <div className="mb-8">
              <span className="text-blue-600 font-semibold text-sm tracking-wider uppercase">Streamlined Journey</span>
              <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 mt-1">4 Easy Steps to Unlock Your Funds</h2>
            </div>
